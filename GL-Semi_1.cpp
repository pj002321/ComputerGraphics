...
{
	GLchar* vertexsource;
	vertexsource = filetobuf("vertexlighting.glsl");
...
void make_fragmentShaders()
{
	...
	fragmentsource = filetobuf("fragmentlighting.glsl");
...
int main(int argc, char** argv)
{
	...
	readobjNomal("cube.obj", ObjVertexVal[0], ObjNomarVal[0]);
	readobjNomal("Sphere2.obj", ObjVertexVal[1], ObjNomarVal[1]);
	for (int i = 2; i < 9; i++)
	{
		readobjNomal("cube.obj", ObjVertexVal[i], ObjNomarVal[i]);
	}

	readobjNomal("j_body.obj", ObjVertexVal[9], ObjNomarVal[9]);
	readobjNomal("cube.obj", ObjVertexVal[10], ObjNomarVal[10]);
	readobjNomal("cube.obj", ObjVertexVal[11], ObjNomarVal[11]);
	readobjNomal("cube.obj", ObjVertexVal[12], ObjNomarVal[12]);
	readobjNomal("cube.obj", ObjVertexVal[13], ObjNomarVal[13]);

	readobjNomal("j_body.obj", ObjVertexVal[14], ObjNomarVal[14]);
	readobjNomal("cube.obj", ObjVertexVal[15], ObjNomarVal[15]);
	readobjNomal("cube.obj", ObjVertexVal[16], ObjNomarVal[16]);
	readobjNomal("cube.obj", ObjVertexVal[17], ObjNomarVal[17]);
	readobjNomal("cube.obj", ObjVertexVal[18], ObjNomarVal[18]);

	readobjNomal("j_body.obj", ObjVertexVal[19], ObjNomarVal[19]);
	readobjNomal("cube.obj", ObjVertexVal[20], ObjNomarVal[20]);
	readobjNomal("cube.obj", ObjVertexVal[21], ObjNomarVal[21]);
	readobjNomal("cube.obj", ObjVertexVal[22], ObjNomarVal[22]);
	readobjNomal("cube.obj", ObjVertexVal[23], ObjNomarVal[23]);

	readobjNomal("j_body.obj", ObjVertexVal[24], ObjNomarVal[24]);
	readobjNomal("cube.obj", ObjVertexVal[25], ObjNomarVal[25]);
	readobjNomal("cube.obj", ObjVertexVal[26], ObjNomarVal[26]);
	readobjNomal("cube.obj", ObjVertexVal[27], ObjNomarVal[27]);
	readobjNomal("cube.obj", ObjVertexVal[28], ObjNomarVal[28]);

	readobjNomal("j_body.obj", ObjVertexVal[29], ObjNomarVal[29]);
	readobjNomal("cube.obj", ObjVertexVal[30], ObjNomarVal[30]);
	readobjNomal("cube.obj", ObjVertexVal[31], ObjNomarVal[31]);
	readobjNomal("cube.obj", ObjVertexVal[32], ObjNomarVal[32]);
	readobjNomal("cube.obj", ObjVertexVal[33], ObjNomarVal[33]);

	readobjNomal("cube.obj", ObjVertexVal[34], ObjNomarVal[34]);
	readobjNomal("cube.obj", ObjVertexVal[35], ObjNomarVal[35]);
	readobjNomal("cube.obj", ObjVertexVal[36], ObjNomarVal[36]);

	readobjNomal("Sphere2.obj", ObjVertexVal[37], ObjNomarVal[37]);
